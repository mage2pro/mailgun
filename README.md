This extension integrates a Magento 2 based webstore with the [Mailgun](https://www.mailgun.com) transactional email API service.
...
### 2. Self-installation
```
composer require mage2pro/mailgun:*
...
## Support
- [The extension's **forum** branch](https://mage2.pro/c/extensions/mailgun).
...
- [Subscribe](https://mage2.pro/t/2540) to the extension's [forum branch](https://mage2.pro/c/extensions/mailgun).
